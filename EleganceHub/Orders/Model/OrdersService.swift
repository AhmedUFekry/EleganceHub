...
protocol OrdersServiceProtocol {
    ...
    func deleteOrder(orderID: Int, completionHandler:@escaping (Int) -> Void)
...
class OrdersService: OrdersServiceProtocol {
 ...
 //"https://mad44-ism-ios1.myshopify.com/admin/api/2024-04/customers/8268495585555/orders.json?&access_token=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"
